# P1 Land Management — Agent Instructions

## Project Context

This project is the P1 Land & Property Management marketing website serving
large-acreage customers in Upstate South Carolina and the greater Charlotte
region. Optimize for truthful customer proof, qualified business inquiries,
reliable lead handling, search discoverability, accessibility, performance, and
maintainable operations. Product facts and publication permissions must be
verified with the Owner. The current audit and implementation plan are proposals
until accepted; they do not grant production-release authority.
