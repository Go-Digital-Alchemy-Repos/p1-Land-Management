    ...
    <div className="app">
      ...
      <div className="workspace">
        ...
        <main className="content">
          {!accountWorkspace && view !== "Website Documents" && (routeUnavailable || !["Website Forms", "Media Library", "CMS Pages", "Website Sections", "Website Editor", "Website Galleries", "Website Head Tags", "Website Blog", "Website Menus"].includes(view)) && <div className={view === "Overview" ? "page-heading page-hero" : "page-heading"}>
            <div>
