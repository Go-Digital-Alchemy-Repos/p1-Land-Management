    ...
    <div className="app">
      ...
      <div className="workspace">
        ...
        <main className="content">
          ...
          {view === "Website Editor" && <Suspense fallback={<p role="status">Loading website editor…</p>}><WebsiteEditor canUseBlog={can("marketing.content.blog")} canUseMedia={can("marketing.content.media")} key={`${person.id}:${(person.capabilities || []).join(",")}`}/></Suspense>}
