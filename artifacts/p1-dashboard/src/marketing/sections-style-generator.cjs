...
const source =
  ...
  ["cms-section-list-presentation.tsx", "cms-section-editor-presentation.tsx"]
    .map((file) =>
      fs.readFileSync(
    ...
    .join("\n") +
  fs.readFileSync(
    root + "/artifacts/p1-dashboard/src/marketing/SectionManager.tsx",
    "utf8",
  );
...
req("postcss")([
  req("tailwindcss")({
    ...
    important: ".cms-section-presentation",
  ...
  .then((result) =>
    fs.writeFileSync(
      root +
        "/artifacts/p1-dashboard/src/marketing/sections-presentation.utilities.css",
