...
const source =
  ...
  ["structured-website-editor-presentation.tsx"]
    .map((file) =>
      fs.readFileSync(
    ...
    .join("\n") +
  fs.readFileSync(
    root + "/artifacts/p1-dashboard/src/marketing/WebsiteEditor.tsx",
    "utf8",
  );
...
req("postcss")([
  req("tailwindcss")({
    ...
    important: ".structured-website-presentation",
  ...
  .then((result) =>
    fs.writeFileSync(
      root +
        "/artifacts/p1-dashboard/src/marketing/website-editor.utilities.css",
