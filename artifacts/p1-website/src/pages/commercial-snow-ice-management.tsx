...
const PROPERTY_TYPES = [
  { icon: Truck, title: "Distribution & fulfillment centers", description: "Snow clearing around dock aprons, truck courts, staging lanes, and employee lots, planned around deliveries and shifts." },
  ...
  { icon: ShoppingCart, title: "Shopping centers & retail complexes", description: "Snow and ice treatment for storefront walkways, fire lanes, and busy parking lots." },
  ...
  { icon: Hospital, title: "Medical, institutional & large-format commercial", description: "Medical and institutional properties with important staff, visitor, and emergency-access needs." },
] as const;
...
const SERVICES = [
  ...
  ["24/7 Storm Monitoring & Emergency Response", "We track the forecast and prepare crews for the response times set out in each site's agreement."],
] as const;

const REASONS = [
  ["Commercial and industrial focus", "We plan crews and equipment around large parking lots, truck courts, and industrial yards."],
  ...
  ["Liability-aware service", "Clear service records showing when lots and walkways were treated."],
  ["One plan and one point of contact", "Plowing, ice treatment, walkway care, and hauling planned under one seasonal agreement."],
] as const;
...
const STEPS = [
  ...
  ["24/7 storm monitoring", "We track forecasts and schedule pre-treatment and crews according to your plan."],
...
const FAQS = [
  ...
  { question: "What's the difference between snow plowing and snow removal (hauling)?", answer: "Plowing moves snow to a suitable place on your property. Hauling takes it away when there isn't enough room, helping keep parking, loading areas, and sightlines clear. We'll review which your site needs." },
  ...
  { question: "Are you insured?", answer: "Ask us for current insurance documents and share your vendor requirements before scheduling. We'll review the paperwork and coverage needed for the work with your team." },
  ...
  return (
    <Layout>
      ...
      <PageHero
        ...
        subtitle="Plan ahead for snow and ice around your parking lots, loading areas, and walkways. We serve large commercial and industrial properties across greater Charlotte and Upstate South Carolina."
        image={heroImg}
      ...
      <section className="bg-background py-24">
        <div className="site-shell space-y-20">
          <FeatureRow heading="In the Carolinas, the risk isn't the snowfall — it's the ice event no one saw coming" image={pretreatmentImg} imageAlt="Large pickup truck with a front plow and anti-icing equipment treating an industrial parking lot">
            ...
            <p>We walk your property before winter, map the areas that need attention first, and put the response plan in writing. When weather approaches, we prepare crews and equipment around that plan.</p>
          </FeatureRow>

          <div className="space-y-8">
            <div className="max-w-3xl"><p className="text-xs font-bold uppercase tracking-[0.24em] text-primary">Who we serve</p><h2 className="mt-3 text-3xl font-serif font-bold text-secondary">Built for large commercial and industrial properties</h2><p className="mt-4 text-lg leading-relaxed text-secondary/80">We serve commercial and industrial properties 1 acre and larger. We do not service residential driveways or small lots.</p></div>
            ...
            <p className="border-l-4 border-primary pl-5 text-lg font-bold italic text-secondary">Tell us how your site operates, which entrances matter most, and when people need access.</p>
          </div>

          <div className="space-y-8">
            <div className="max-w-3xl"><p className="text-xs font-bold uppercase tracking-[0.24em] text-primary">A Plan for Your Site</p><h2 className="mt-3 text-3xl font-serif font-bold text-secondary">Complete commercial snow and ice services — from a single contractor</h2><p className="mt-4 text-lg leading-relaxed text-secondary/80">One seasonal agreement sets out the services, priorities, and person to contact for your site.</p></div>
          ...
          <FeatureRow heading="Why large properties across the Carolinas choose P1" image={loadingDockImg} imageAlt="Large pickup truck with a front-mounted snowplow clearing a distribution center loading dock" reverse>
            <p>Before winter arrives, we'll walk the site, identify priority areas, and explain when and how the crew will respond.</p>
            <p>The plan covers lots, loading areas, entrances, walkways, and where to put cleared snow.</p>
          </FeatureRow>
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="border-l-4 border-primary bg-muted p-7"><h2 className="text-2xl font-serif font-bold text-secondary">Managing a data center, secure facility, or distribution campus?</h2><p className="mt-3 leading-relaxed text-secondary/75">Connect winter readiness with the year-round perimeter, stormwater, grading, and access needs around the same facility.</p><Link href="/commercial/data-centers-secure-facilities" className="mt-5 inline-block font-bold text-primary underline">Explore secure facility exterior grounds management</Link></div>
