    ...
    <Layout>
      ...
      <section className="relative py-32 px-4 bg-secondary text-white text-center overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-30 mix-blend-overlay">
          <img src={heroImg} alt="Land & Property Management Near Mooresville & Lake Norman, NC" className="w-full h-full object-cover" />
