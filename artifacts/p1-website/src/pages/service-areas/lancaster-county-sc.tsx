...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "Yes. P1 offers pasture management, field reseeding, drainage, ring and paddock grading, selective clearing, and pond maintenance for horse farms and equestrian operations around Van Wyck and northern Lancaster County.",
  },
  {
      ...
      <SEO
        ...
        jsonLd={[
          serviceAreaSchema({
            ...
            description:
              "P1 Land & Property Management serves commercial, industrial, agricultural, equestrian, municipal, and institutional properties across Lancaster County, SC. Land clearing, grading, drainage, pasture, turf, and pond management in Indian Land, Van Wyck, Kershaw, Heath Springs, Lancaster & more. Call (704) 221-8928.",
      ...
      <section className="py-24 bg-background">
        <div className="site-shell space-y-16">
          ...
          <FeatureRow heading="Your Lancaster County Property Partner" image={featureImg} imageAlt="Large-acreage property management in Lancaster County, SC">
            <p>
              Lancaster County is one of the fastest-growing counties in the Charlotte region. Its northern panhandle around Indian Land and Van Wyck has seen major commercial, industrial, and institutional development — while the central and southern reaches around Lancaster, Kershaw, and Heath Springs remain defined by working farmland, pasture, timber, and equestrian operations.
            </p>
            <p>
              That combination is exactly what P1 Land & Property Management is built for. Whether you manage a commercial site in Indian Land, a developing tract along the U.S. 521 corridor, an equestrian property near Van Wyck, or working agricultural acreage outside Kershaw, P1 delivers the equipment, expertise, and reliability that large Lancaster County properties demand.
            </p>
          </FeatureRow>
          ...
          <div className="bg-muted p-8 rounded-xl border border-border shadow-sm space-y-4">
            ...
            <div className="prose prose-lg prose-p:text-secondary/80 max-w-none space-y-4">
              <p>
                The Waxhaws region straddling the North Carolina line — including Van Wyck and northern Lancaster County — has a strong concentration of horse farms, barns, and equestrian operations, and agriculture remains a genuine part of the county's identity south toward Kershaw and Heath Springs. These properties need commercial-scale care: pasture management and reseeding, drainage across large fenced tracts, footing and grading for rings and paddocks, selective clearing along fence lines, and pond maintenance for livestock and irrigation.
              </p>
              <p>
          ...
          <div className="space-y-4">
            ...
            <div className="prose prose-lg prose-p:text-secondary/80 max-w-none space-y-4">
              ...
              <p>
                From single land-clearing and grading projects to full-service maintenance contracts, P1 gives Lancaster County commercial, industrial, agricultural, equestrian, municipal, and institutional property teams one contractor for the entire life of their land — from initial clearing and reconstruction through ongoing weekly and seasonal care.
              </p>
            </div>
          </div>
