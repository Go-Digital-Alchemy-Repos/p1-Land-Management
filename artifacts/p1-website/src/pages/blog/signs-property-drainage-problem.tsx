    ...
    <Layout>
      ...
      <article className="pb-24">
        ...
        <section className="relative w-full h-[50vh] min-h-[400px] overflow-hidden bg-secondary">
          <img src={heroImg} alt="Heavy equipment drainage trench" className="absolute inset-0 w-full h-full object-cover opacity-50 mix-blend-overlay" />
          ...
          <div className="container relative z-10 mx-auto px-4 h-full flex flex-col justify-end pb-16 max-w-4xl text-center md:text-left">
            <div className="mb-4 text-primary font-bold tracking-wider uppercase text-sm">Drainage Solutions</div>
