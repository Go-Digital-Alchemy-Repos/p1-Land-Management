...
const values = [
  {
    n: "01",
    title: "Equipment Matched to the Work",
    desc: "We check access and bring the equipment suited to your clearing, grading, or maintenance job.",
    icon: Truck,
  },
  {
    n: "02",
    title: "Large-Acreage Expertise",
    desc: "Crews and equipment for farms, industrial grounds, public sites, and commercial campuses.",
    icon: Ruler,
  },
  {
    n: "03",
    title: "Drainage Planning",
    desc: "We look at where water collects and how it moves before recommending drainage work. We'll explain when an engineer or other specialist is needed.",
    icon: Droplets,
  },
  {
    n: "04",
    title: "A Clear Plan Before We Start",
    desc: "Before work starts, you'll know what we're doing, who to contact, and when to expect the crew.",
    icon: CalendarCheck,
  },
];
  ...
  return (
    <Layout>
      ...
      <section className="relative overflow-hidden bg-navy-deep">
        <div className="absolute inset-0">
          <img
            ...
            fetchPriority="high"
            decoding="async"
            {...responsiveImageProps(heroImg, "100vw")}
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(105deg, hsl(215 50% 11%) 8%, hsl(215 50% 11% / 0.86) 38%, hsl(215 50% 11% / 0.35) 72%, transparent 100%)",
          }}
        />
        <div
          className="absolute inset-0"
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, transparent, hsl(40 20% 98%))",
          }}
        />
        ...
        <div className="site-shell relative grid grid-cols-1 gap-8 lg:grid-cols-12 pb-28 pt-24 lg:pt-28">
          <div className="min-w-0 lg:col-span-8">
            ...
            <h1
              style={{
                color:
                  "hsl(var(--public-text-h1, var(--public-text-inverse, 0 0% 100%)))",
              }}
              className="max-w-3xl font-display text-[clamp(2.6rem,6.4vw,5.4rem)] font-light leading-[0.98] tracking-[-0.02em] text-white"
            >
              First impressions{" "}
              <em
            ...
            <p
              ...
              style={{
                color:
                  "hsl(var(--public-text-heading-subtext, 40 20% 92%) / 0.82)",
              }}
            >
              Commercial landscaping and exterior grounds maintenance that keep
              your property looking professional, welcoming, and well cared for.
            </p>
            <div className="mt-9 flex flex-wrap items-center gap-4">
              <Button
                asChild
                size="lg"
                className="group h-12 rounded-[3px] border-0 bg-primary px-4 sm:px-7 font-sans text-[15px] font-bold text-primary-foreground hover:bg-primary/90"
                style={{ boxShadow: "0 18px 40px -14px hsl(206 70% 48%)" }}
              >
                <Link href="/contact">
              ...
              <a
                href="tel:7042218928"
                className="inline-flex items-center gap-2 rounded-[3px] border px-7 py-2.5 font-sans text-[15px] font-bold text-white transition-colors hover:bg-white/10"
                style={{ borderColor: "hsl(40 30% 90% / 0.35)" }}
              >
        ...
        <div className="site-shell">
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 30px 60px -32px hsl(215 45% 15%), 0 8px 18px -12px hsl(215 40% 20% / 0.3)",
            }}
          >
            {trust.map((t, i) => (
              <div
              ...
              >
                ...
                <span className="font-sans text-[13px] font-bold leading-tight text-secondary">
                  {t.label}
                </span>
              </div>
            ))}
      ...
      <section className="relative bg-background py-24">
        <div className="site-shell">
          <div className="mb-14 flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
            ...
            >
              From regular mowing to drainage repairs and site preparation, we
              help you take care of the whole property.
            </p>
          </div>
        ...
        <div className="site-shell relative grid grid-cols-1 items-center gap-10 lg:grid-cols-12">
          <div className="min-w-0 lg:col-span-7">
            <div className="relative">
              <div
                className="absolute -left-4 -top-4 h-full w-full rounded-[4px] bg-primary"
                style={{ opacity: 0.9 }}
              />
              ...
              >
                <img
                  ...
                  loading="lazy"
                  decoding="async"
                  {...responsiveImageProps(featureImg)}
                  className="h-[420px] w-full object-cover"
                />
              </div>
              <div
                className="absolute -bottom-6 left-8 z-10 rounded-[3px] bg-navy px-5 py-4 text-white"
                style={{ boxShadow: "0 20px 40px -18px hsl(215 45% 15%)" }}
              >
                <div className="font-sans text-3xl font-black leading-none text-tan">
                  Site Prep
                </div>
                <div
                  className="mt-1 text-[10px] font-semibold uppercase text-white"
          ...
          <div className="min-w-0 lg:col-span-5 lg:pl-6">
            ...
            <p
              ...
              style={{ color: "hsl(215 20% 34%)" }}
            >
              A good building site starts with the ground underneath it. We
              prepare pads and grades and plan drainage with your project team
            ...
            <div className="mt-8">
              <Link
                ...
                className="inline-flex items-center gap-2 font-sans text-sm font-bold uppercase text-primary"
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
            <div className="min-w-0 lg:col-span-4">
              ...
              <h2 className="mt-4 font-display text-[clamp(2rem,4vw,3.2rem)] font-light leading-[1.03] tracking-[-0.02em] text-white">
                ...
                <span className="text-tan" style={{ fontStyle: "italic" }}>
                  groundwork.
                </span>
              </h2>
              <p
              ...
              >
                We look at how your land, water, trees, and turf work together,
                then plan the care each needs.
              </p>
              <div
                className="mt-8 inline-flex items-center gap-2 rounded-[3px] px-4 py-2 font-sans text-[12px] font-bold uppercase"
                style={{
            ...
            <div className="min-w-0 lg:col-span-8">
              <div
                className="grid grid-cols-1 gap-px overflow-hidden rounded-[4px] sm:grid-cols-2"
                style={{ background: "hsl(40 30% 90% / 0.1)" }}
              >
                {values.map((v) => (
                  <div key={v.n} className="group relative bg-navy-deep p-8">
                    <div className="flex items-start justify-between">
                      ...
                      >
                        <v.icon
                          className="h-5 w-5"
                          style={{ color: "hsl(206 70% 48%)" }}
                        />
                      </span>
                      <span
                        className="font-sans text-2xl font-black tabular-nums"
                        style={{ color: "hsl(40 30% 90% / 0.16)" }}
                      >
                        {v.n}
                      </span>
                    </div>
        ...
        <div className="mx-auto max-w-[1100px] px-6">
          <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-12">
            <div className="min-w-0 md:col-span-5">
              <div className="relative">
                <div
                  className="absolute -left-3 -top-3 h-full w-full rounded-[4px] bg-clay"
                  style={{ opacity: 0.9 }}
                />
                <div
                  className="relative overflow-hidden rounded-[4px] border-4 border-white"
                  style={{ boxShadow: "0 30px 60px -28px hsl(215 45% 15%)" }}
                >
                  <img
                    src={propertyPlanningImg}
                    alt="Illustrative commercial property"
                    loading="lazy"
                    decoding="async"
                    {...responsiveImageProps(propertyPlanningImg)}
            ...
            <div className="min-w-0 md:col-span-7 md:pl-4">
              <h2 className="font-display text-3xl text-secondary">
                Care for the Whole Property
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-secondary">
                Start with what needs attention now. We'll help you plan
                clearing, grading, drainage, and regular upkeep as your property
                needs change.
              </p>
              <Link
                href="/contact"
                className="mt-7 inline-block font-bold text-primary underline"
              >
        ...
        <div className="site-shell">
          ...
          <div className="mx-auto grid max-w-4xl grid-cols-1 gap-6 text-left md:grid-cols-2">
            <div
              ...
              style={{
                borderColor: "hsl(215 30% 15% / 0.08)",
                boxShadow: "0 14px 40px -30px hsl(215 45% 15%)",
              }}
            >
              <h3
                className="mb-5 border-b pb-4 font-serif text-2xl font-bold text-primary"
                style={{ borderColor: "hsl(215 30% 15% / 0.08)" }}
              >
              ...
              >
                <Link
                  ...
                  href="/service-areas/greenville-sc"
                >
                  Greenville
                </Link>{" "}
                ·{" "}
                <Link
                  className="underline hover:text-primary"
                  href="/service-areas/spartanburg-sc"
                >
                  Spartanburg
                </Link>{" "}
                ·{" "}
                <Link
                  className="underline hover:text-primary"
                  href="/service-areas/anderson-sc"
                >
                  Anderson
                </Link>{" "}
                ·{" "}
                ...
                <Link
                  className="underline hover:text-primary"
                  href="/service-areas/simpsonville-sc"
                >
                  Simpsonville
                </Link>{" "}
                ·{" "}
                ...
                <Link
                  className="underline hover:text-primary"
                  href="/service-areas/boiling-springs-sc"
                >
                  Boiling Springs
                </Link>
              </p>
            ...
            >
              ...
              >
                <Link
                  className="underline hover:text-primary"
                  href="/service-areas/charlotte-north-carolina"
                >
                  Charlotte
                </Link>{" "}
                ·{" "}
                ...
                <Link
                  className="underline hover:text-primary"
                  href="/service-areas/mooresville-lake-norman-nc"
                >
                  Mooresville
                </Link>{" "}
                ·{" "}
                ...
                <Link
                  className="underline hover:text-primary"
                  href="/service-areas/kannapolis-nc"
                >
                  Kannapolis
                </Link>{" "}
                ·{" "}
                ...
                <Link
                  className="underline hover:text-primary"
                  href="/service-areas/indian-trail-nc"
                >
                  Indian Trail
                </Link>{" "}
                ·{" "}
                ...
                <Link
                  className="underline hover:text-primary"
                  href="/service-areas/indian-land-sc"
                >
                  Indian Land
                </Link>
              </p>
      ...
      <section className="bg-background pb-24">
        <div className="mx-auto max-w-[900px] px-6">
          ...
          <p className="mt-10 border-l-4 border-primary pl-4 font-bold text-secondary">
            ...
            <a href="tel:7042218928" className="text-primary hover:underline">
              +1 (704) 221-8928
            </a>{" "}
            or{" "}
      ...
      <section className="site-shell py-12">
        <div className="border-l-4 border-primary bg-muted p-7">
          <h2 className="text-2xl font-bold">
            Managing a commercial or industrial property?
          </h2>
          <p className="mt-3 text-muted-foreground">
            Talk through grounds care, drainage, clearing, and repairs with one
            team.
          </p>
          <div className="mt-5 flex flex-wrap gap-x-6 gap-y-3">
            ...
            >
              Explore Commercial Site Management
            </Link>
            <Link
              href="/commercial/data-centers-secure-facilities"
              className="font-bold text-primary underline"
            >
              Data center & secure facility grounds
            </Link>
          </div>
        </div>
      </section>
