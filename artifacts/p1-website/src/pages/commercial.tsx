...
const capabilities = [
  { title: 'Grounds & Vegetation Management', text: 'Bring acreage, overgrowth and perimeter vegetation into a practical maintenance plan.', href: '/services/commercial-landscaping', label: 'Commercial landscaping services', value: 'grounds_vegetation' },
  ...
  { title: 'Recurring Site Management', text: 'Build an agreed maintenance schedule with inspection priorities, communication and follow-up expectations defined together.', href: '/services/commercial-landscaping', label: 'Ongoing commercial landscaping', value: 'recurring_site_management' },
  { title: 'Commercial Snow & Ice Management', text: 'Plan seasonal plowing, anti-icing and documented storm response around your site, access priorities and winter risk.', href: '/commercial-snow-ice-management', label: 'Snow and ice management', value: 'commercial_snow_ice' },
];
