...
export default function Commercial() {
  return <Layout assessmentCta>
    ...
    <section className="relative isolate overflow-hidden bg-secondary text-white">
      <img src={hero} alt="Illustrative aerial view of maintained commercial grounds" fetchPriority="high" sizes="100vw" className="absolute inset-0 -z-20 h-full w-full object-cover" />
      <div className="absolute inset-0 -z-10 bg-slate-950/80" />
      <div className="container mx-auto px-5 py-20 md:py-28"><div className="max-w-4xl">
    ...
    <section className="container mx-auto px-5 py-20"><div className="grid items-center gap-12 lg:grid-cols-2">
