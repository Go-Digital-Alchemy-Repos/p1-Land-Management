...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/60 shadow-md shadow-black/5 backdrop-blur supports-[backdrop-filter]:bg-background/60 bg-background">
