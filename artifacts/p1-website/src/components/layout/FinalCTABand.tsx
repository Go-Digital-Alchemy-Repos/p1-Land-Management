...
const variants: Record<
  CtaVariant,
  { heading: string; body: string; primary: string; href: string }
> = {
  maint: {
    ...
    primary: "Request a Maintenance Bid",
  ...
  site: {
    ...
    primary: "Get a Site-Work Quote",
    href: "/contact?type=sitework",
  },
  farm: {
    ...
    primary: "Get a Price on Your Acreage",
    href: "/contact?type=farm",
  },
  snow: {
    ...
    primary: "Schedule a Pre-Season Walk",
    href: "/contact?type=snow",
  },
  general: {
...
/** The visible CTA band, usable without the optional related-links section. */
    ...
    >
      <div className="absolute inset-0">
        <img
          ...
          loading="lazy"
          decoding="async"
          {...responsiveImageProps(ctaImg, "100vw")}
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(100deg, hsl(215 50% 11%) 30%, hsl(208 64% 40% / 0.4))",
        }}
      />
      ...
      <div className="site-shell relative flex flex-col items-center gap-8 py-20 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <Button
            asChild
            size="lg"
            className="group h-12 rounded-[3px] border-0 bg-white px-8 font-sans text-[15px] font-bold text-secondary hover:bg-white/90"
            style={{ boxShadow: "0 18px 40px -16px hsl(0 0% 0% / 0.5)" }}
          >
            <Link href={copy.href}>
              {copy.primary}
          ...
          <a
            href="tel:7042218928"
            className="inline-flex items-center gap-2 rounded-[3px] border px-8 py-2.5 font-sans text-[15px] font-bold text-white transition-colors hover:bg-white/10"
            style={{ borderColor: "hsl(40 30% 90% / 0.4)" }}
          >
