...
const cache = new Map(staticRoutes.map(path => [path, render(path)]));
...
console.log(`PASS ${staticRoutes.length} content-plan routes: CTA variants, sitemap, business schema and FAQ visibility/schema parity.`);
