...
Production source extraction/freezing, unmatched parent creation policy, complete source-field functionality, full import reconciliation/restoration rehearsals and `/admin/` retirement remain open release gates.
