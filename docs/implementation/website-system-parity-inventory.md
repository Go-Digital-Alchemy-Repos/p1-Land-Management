...
Paths in this table are relative to the existing router mounts. Canonical new bridge paths and generated client contracts must be added together with their implementations and authorization tests. All five destinations remain unimplemented in the consolidated navigation as of this inspection.
