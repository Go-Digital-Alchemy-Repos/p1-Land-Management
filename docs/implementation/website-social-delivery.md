...
Responsive follow-up: the recorded homepage grid overflow has since been corrected, together with narrow-screen footer wrapping. The browser now verifies homepage, social-row and feature-image containment at 320/390/768/1024/1280px. This supersedes the earlier open mobile-grid issue; production font and full-site appearance acceptance remain pending.
