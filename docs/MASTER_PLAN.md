...
- Client, staff and crew experiences; Better Auth for the business platform; Node.js/TypeScript, PostgreSQL, Drizzle and Railway. Existing copied CMS authentication remains isolated; do not silently substitute or merge identity systems.
