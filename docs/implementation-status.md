...
|---|---|---|
| Public website |35 routes including `/commercial` deployed to staging as prebuilt runtime `ba5ce29a-cdea-468a-ae81-1bfba6d4ec6f` from website revision `f0ac9b2b6511b7c480d9677074bb86ec1fedf366`; production still serves its previous release | Final staged browser/content acceptance, shared CMS identity, production gateway/cache provisioning and exact-source rollout |
...
| Business dashboard | Staging web `9b635606-528a-470e-b085-66bd4e884a4b` and isolated worker `4a3911b2-9f0d-4d5f-94c5-5a88513367ed` SUCCESS; durable agreement draft preparation (`0018`), retry-stable agreement reviews, publication-gated inspection/property history, charge history, worker observability and enforced owner MFA are deployed in staging | Browser role/decision acceptance, actual owner recovery/enrollment, provider/device/pilot gates and production release |
