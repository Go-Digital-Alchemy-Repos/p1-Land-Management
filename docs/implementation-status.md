...
|---|---|---|
| Public website |35 routes including `/commercial` deployed to staging as prebuilt runtime `fd988cae-d608-407d-b4ec-0b79ccb9d580` from website revision `8f7578473d9d96d1d238163dbfe73814b5b69150`; the shared 1,240px public frame now covers the header, page heroes, footer and final CTA. Production still serves its previous release | Final staged browser/content acceptance, shared CMS identity, production gateway/cache provisioning and exact-source rollout |
| Independent P1 Core | Federation consumer staging restart `78fa0eca-840e-4df7-bfaa-73ecf514ea32` SUCCESS from `f219835`; isolated CMS, managed forms, private proof and commercial sender remain available | Production Core is separate; final owner/shared-identity and public-gateway acceptance remain |
| Business dashboard | Staging web `97ed4ce3-b7a8-4860-b7a7-c4763f45238b` and isolated worker `4a3911b2-9f0d-4d5f-94c5-5a88513367ed` SUCCESS; durable agreement draft preparation (`0018`), retry-stable agreement reviews, publication-gated inspection/property history, charge history, worker observability, enforced owner MFA, audit-backed service-request creation, and iOS/Android PWA launcher metadata are deployed in staging | Browser role/decision acceptance, actual owner recovery/enrollment, provider/device/pilot gates and production release |
