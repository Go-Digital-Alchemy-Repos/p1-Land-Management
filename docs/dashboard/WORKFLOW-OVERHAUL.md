...
- The dashboard React test config resolves one React runtime across retained Core components. All 166 UI tests pass; 44 Node route and utility tests pass separately.
