...
- Complete cancellation/billing correction, project phase/progress accounting workflows, crew availability conflict checks and full report publication workflows. Fixed-monthly/per-visit automatic draft preparation is deployed to isolated staging with durable scan/job/retry records and a worker-created draft rehearsal; production release and pilot acceptance remain open. Agreement creation, activation, cancellation, successor creation and explicit charge preparation are reviewed in04ef3ad; combined staging acceptance remains on hold. Equipment/access/materials/permit/deposit readiness editing and override invalidation are reviewed and included in productionbc7d3a6. These bounded features do not establish end-to-end operational acceptance.
