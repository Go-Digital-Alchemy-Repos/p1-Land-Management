...
artifact = root / "dist/operations/apply-legacy-upload-migration.mjs"
...
expected = {
    ...
    "mode": "apply",
    "complete": False,
    "error": "Apply failed or was rejected. Writes may have occurred; preserve objects and inspect the ledger before a verified retry.",
}
with tempfile.TemporaryDirectory(prefix="core-upload-apply-smoke-") as directory:
