// Run from platform/p1-core: npx vitest run --config client/src/components/shared/pages-native-adapter.vitest.config.ts
...
export default {
  test: {
    ...
    include: [
      local("../../../../../../artifacts/p1-dashboard/tests/pages-native-adapter.spec.tsx"),
      local("../../../../../../artifacts/p1-dashboard/tests/page-lease.spec.tsx"),
      local("../../../../../../artifacts/p1-dashboard/tests/menu-concurrency.spec.tsx"),
    ],
  },
  resolve: {
    alias: {
