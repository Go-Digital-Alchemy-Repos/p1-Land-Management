// Run from platform/p1-core: npx vitest run --config client/src/components/shared/forms-native-adapter.vitest.config.ts
...
export default {
  test: {
    ...
    include: [
      local("../../../../../../artifacts/p1-dashboard/tests/forms-native-adapter.spec.tsx"),
    ],
  },
  resolve: {
    alias: {
