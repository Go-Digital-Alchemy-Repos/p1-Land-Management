// Run from platform/p1-core: npx vitest run --config client/src/components/shared/integrations-native-adapter.vitest.config.ts
...
export default {
  test: {
    ...
    include: [local("../../../../tests/dashboard/website-integrations.test.tsx")],
  },
  resolve: {
    alias: {
