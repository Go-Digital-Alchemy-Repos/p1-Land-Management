// Run from platform/p1-core: npx vitest run --config client/src/components/shared/documents-native-adapter.vitest.config.ts
...
export default {
  test: {
    ...
    include: [
      local("../../../../tests/dashboard/documents.test.tsx"),
    ],
  },
  resolve: {
    alias: {
