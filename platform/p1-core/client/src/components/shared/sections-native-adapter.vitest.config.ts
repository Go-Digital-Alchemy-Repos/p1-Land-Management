// Run from platform/p1-core: npx vitest run --config client/src/components/shared/sections-native-adapter.vitest.config.ts
...
export default {
  test: {
    ...
    include: [
      local("../../../../../../artifacts/p1-dashboard/tests/sections-native-adapter.spec.tsx"),
    ],
  },
  resolve: {
    alias: {
