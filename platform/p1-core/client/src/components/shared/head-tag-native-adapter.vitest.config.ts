// Run from platform/p1-core: npx vitest run --config client/src/components/shared/head-tag-native-adapter.vitest.config.ts
...
export default {
  test: {
    ...
    include: [
      local("../../../../../../artifacts/p1-dashboard/tests/head-tag-native-adapter.spec.tsx"),
    ],
  },
  resolve: {
    alias: {
