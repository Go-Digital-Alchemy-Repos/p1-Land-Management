// Run from platform/p1-core: npx vitest run --config client/src/components/shared/email-native-adapter.vitest.config.ts
...
export default {
  test: {
    ...
    include: [
      local("../../../../tests/dashboard/email-templates.test.tsx"),
    ],
  },
  resolve: {
    alias: {
