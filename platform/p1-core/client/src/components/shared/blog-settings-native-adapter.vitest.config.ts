// Run from platform/p1-core: npx vitest run --config client/src/components/shared/blog-settings-native-adapter.vitest.config.ts
...
export default {
  test: {
    ...
    include: [
      local("../../../../../../artifacts/p1-dashboard/tests/blog-settings-native-adapter.spec.tsx"),
    ],
  },
  resolve: {
    alias: {
