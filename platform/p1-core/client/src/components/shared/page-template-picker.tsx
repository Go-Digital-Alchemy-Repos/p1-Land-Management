...
import type { PageTemplatePrimitives } from "./page-template-primitives";
import { useState } from "react";
import { FileText, Sparkles, BookOpen, TrendingUp, Newspaper, Wand2, Check } from "lucide-react";
import { PAGE_TEMPLATES } from "../../../../shared/cms-builder/page-templates";
import type { BuilderContent } from "../../../../shared/cms-builder/block-registry";
...
export function TemplatePicker({
  ...
  const { Dialog, DialogContent, DialogHeader, DialogTitle, DialogFooter, Button, Badge } =
    primitives;
