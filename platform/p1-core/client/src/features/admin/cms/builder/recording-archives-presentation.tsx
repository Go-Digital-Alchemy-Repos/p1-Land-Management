      ...
      <CardFooter className="flex-none p-4 pt-0">
        {preview ? (
          <p className="text-xs text-muted-foreground">
            Playback and purchases are unavailable in this editing preview.
          </p>
        ) : canWatch ? (
          <Button
            className="w-full"
...
export function RecordingArchivesPresentation({
  props = {},
  recordings,
  isLoading = false,
                ...
                {showAccessFilter && (
                  <Select value={accessFilter} onValueChange={setAccessFilter}>
                    ...
                    <SelectContent>
                      ...
                      {isLoggedIn && <SelectItem value="purchased">My Purchases</SelectItem>}
                    </SelectContent>
                  </Select>
                )}
              </div>
