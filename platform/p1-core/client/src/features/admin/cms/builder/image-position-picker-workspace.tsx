...
import { Button as DefaultButton } from "./builder-host";
import { Label as DefaultLabel } from "./builder-host";
import { Crosshair } from "lucide-react";

export interface ImagePositionPickerProps {
  components?: { Button?: ComponentType<any>; Label?: ComponentType<any> };
  imageUrl: string;
  positionX: number;
  positionY: number;
...
export function ImagePositionPicker({
  ...
  const { Button = DefaultButton, Label = DefaultLabel } = components;
