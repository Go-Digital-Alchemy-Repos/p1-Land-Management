import type { CareerJob } from "../../../../../../shared/schema/careers";
import { useMemo, useState } from "react";

import { Link } from "./archive-presentation-host";
import { Briefcase, Building2, MapPin, Search, X } from "lucide-react";

import { Badge } from "./archive-presentation-host";
import { Button } from "./archive-presentation-host";
import { Card, CardContent, CardHeader, CardTitle } from "./archive-presentation-host";
import { Input } from "./archive-presentation-host";
import {
  Select,
  SelectContent,
  SelectItem,
...
import { Skeleton } from "./archive-presentation-host";

import { stripHtml } from "../../../../lib/html";
import {
  CAREER_EMPLOYMENT_TYPE_LABELS,
  CAREER_WORK_MODE_LABELS,
} from "../../../../../../shared/careers-display";
...
export function CareerListingsPresentation({
  props = {},
  useJobs,
}: {
  props?: Record<string, unknown>;
  useJobs: (query: string) => { jobs: CareerJob[]; isLoading: boolean; filters?: FilterOptions };
}) {
  ...
  const { jobs, isLoading, filters } = useJobs(query);
