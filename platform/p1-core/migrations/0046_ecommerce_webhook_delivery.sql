...
UPDATE ecommerce_processed_webhook_events
SET
  status = 'processed',
...
CREATE INDEX IF NOT EXISTS idx_ecommerce_webhook_status_started
  ON ecommerce_processed_webhook_events (status, started_at);
